...
driver.get("https://demo.guru99.com/test/newtours/register.php");
        ...
        select.selectByIndex(0);// selectByIndex metodu 0 indexi ile başlar
    }
    @Test
    public void selectByValue(){
        ...
        WebElement drpDown= driver.findElement(By.name("country"));
        Select select=new Select(drpDown);
        select.selectByValue("TURKEY");// siteye gidilip"TURKEY" secildi
    ...
    public void selectByVisibleTest(){
        driver.get("https://demo.guru99.com/test/newtours/register.php");
        WebElement drpDown= driver.findElement(By.name("country"));
        //LOCTE EDİLEN SELECTDRPDOWN SELECT OBJEYE DONUŞTU
        Select select=new Select(drpDown);
      select.selectByVisibleText("NEPAL");
        System.out.println(select.isMultiple());// birden çok secim yapmak için kullanılır boolean döner
    ...
    @Test
    public void getOptions(){// Return type List<Webelement>
        driver.get("https://demo.guru99.com/test/newtours/register.php");
       Select select=new Select(driver.findElement(By.name("country")));
       List<WebElement> options =select.getOptions();//secenekleri getirir...
       for (WebElement option:options){
           System.out.println(option.getText());// Tum ülkeleri konsolda secip yazdırdı
       }
    ...
    public  void getFirstSelected(){
     ...
     Select select=new Select(driver.findElement(By.id("fruits")));
        ...
        WebElement selectedOption=select.getFirstSelectedOption();
          System.out.println(selectedOption.getText());// secili olan ilk index elemanını bizze yazdırır.'Orange'


      }
      @Test
    public void getAllSelectOptionTest(){
          driver.get("https://output.jsbin.com/osebed/2");
      Select select=new Select(driver.findElement(By.id("fruits")))   ;
