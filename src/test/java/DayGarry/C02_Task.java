...
public class C02_Task extends BaseTest {
    /*
...
*/
    ...
    public void test(){
        ...
        WebElement hesapolstur= driver.findElement(By.linkText("Yeni Hesap Oluştur"));
        hesapolstur.click();
        WebElement isimgir= driver.findElement(By.xpath("//input[@name='firstname']"));
        Faker faker=new Faker();
        String email=faker.internet().emailAddress();
        Actions actions=new Actions(driver);
        actions.click(isimgir)
                ...
                .sendKeys(String.valueOf(faker.number().numberBetween(1970, 2000))).sendKeys(Keys.TAB).sendKeys(Keys.TAB).sendKeys(Keys.TAB)
